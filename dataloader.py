...
import numpy as np
import argparse
from sparch1.sparch.dataloaders.spiking_datasets import load_shd_or_ssc

from sparch1.sparch.dataloaders.nonspiking_datasets import load_hd_or_sc
...
def load_dataset(dataset='cifar10', datapath='cifar10/data', batch_size=128, \
                 ...
                 trainloader_path="", testloader_path="", args = None):
    """
    ...
    if dataset == 'cifar10':
        ...
        train_loader = load_shd_or_ssc(
                dataset_name="shd",
                data_folder="/Users/dudchenko/local/SHD",
                split="train",
        ...
        train_loader = load_shd_or_ssc(
                dataset_name="ssc",
                data_folder="/Users/dudchenko/local/ssc",
                split="train",
                batch_size=batch_size,
                nb_steps=300,
                max_time = 1.2,
        ...
        train_loader = load_hd_or_sc(
                dataset_name="sc",
                data_folder="/Users/dudchenko/local/GSC",
                split="train",
                batch_size=batch_size, 
                shuffle=True,
                workers=threads,
