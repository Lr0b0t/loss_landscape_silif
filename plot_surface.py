...
def name_surface_file(args, dir_file):
    ...
    surf_file += args.dataset
    surf_file += args.model
    surf_file += "lay"+str(args.nb_layers)
    surf_file += "_hid"+str(args.nb_hiddens)
    print(surf_file + ".h5")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--nb_hiddens', default=128, type=int, help='nb_hiddens')
    parser.add_argument('--nb_layers', default=3, type=int, help='nb_layers')
    parser.add_argument('--pdrop', default=0.1, type=float, help='nb_layers')
    parser.add_argument('--spatial_bin', default=5, type=int, help='spatial_bin')
    ...
    #--------------------------------------------------------------------------
    net = model_loader.load(args, args.dataset, args.model, args.model_file)
    ...
    trainloader, testloader = dataloader.load_dataset(args.dataset, args.datapath,
                                ...
                                args.trainloader, args.testloader, args)
