...
for i, trained_layer in enumerate(trained_net.snn):
  ...
  # Non-negative real, zero imaginary
        ...
        # Unstable (green)
        plt.scatter(real_parts[unstable_mask], imag_parts[unstable_mask], color='yellow', marker='o', label='Unstable', s=5)
        ...
        plt.savefig(f"../../plots/SHD/EV/adLIFclampEVs_layer{i}.png")
        plt.show()
